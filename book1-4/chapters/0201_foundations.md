...
This orientation is a separate thing from comfort, and the separation matters. Health, security, and material ease are useful, and the second part of goodness does not consist of them. Much of what advanced human knowledge came from people who lacked all three and reached upward anyway: the clean-swept dirt floor, the borrowed book read by poor light, the worker who keeps turning a problem over after the day's labor is done. The requirement is direction, the turning of effort toward order, creation, and increase, and that direction is available in poverty as fully as in plenty.

This second part of goodness requires the transmission of knowledge and productive practices across generations, and the maintenance of conditions in which children can reach maturity able to carry the work further than their parents carried it. A society that survives one generation while consuming everything its children would need has refused the upward orientation, and a comfortable refusal is still a refusal.
...
No tier may be dropped. The ordering includes the outer tiers; community, nation, and world all carry real claims. But the ordering cannot be reversed or discarded without removing the base on which any wider duties rest. The familiar adolescent posture of caring intensely about distant strangers while neglecting parents and siblings is an inversion of the order; caring more about distant strangers then your parents isn't a higher form of virtue. A person who cannot maintain duties to family has no surplus from which to serve the world.

One more element belongs here because it is routinely omitted: enemies are real, and they carry negative value in the ordering. Some people intend harm to you, your family, or your society. Treating them as neutral strangers, or as inner-tier members, amounts to a failure to describe reality, and has nothing to do with generosity.
...
The interlock becomes concrete when each principle is removed in turn and the damage is traced:

| Principle removed | What breaks |
|---|---|
| Reality is knowable | No practice can be tested against results, and disputes resolve by power. |
| Humans are limited | Systems are built for angels, and universal obligation replaces scoped duty. |
| Goodness is survival and thriving | Priority loses its purpose, and the will to continue dissolves. |
| Tiered priority | Obligation goes universal, and borders and family preference lose their ground. |
| Procedural symmetry | Priority decays into favoritism, and power loses its bounds. |
...
Each of the five principles admits a coherent inversion, and the inversions hold together exactly the way the originals do. When all five inversions are maintained together, they form a rival set, as organized as the original. Stated plainly, the inversions are these:

<!-- chapter: name the packages outside the axioms, state the test rule and the limits of our sight, explain alliances among rivals, then close the part on what we are for -->
...
<!-- arc: H10 | point: inherited capital is consumed by the generation that mocks the stocking rule; the next generation inherits the mockery without the capital -->

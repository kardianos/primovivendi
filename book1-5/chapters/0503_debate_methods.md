## Methods of Debate that Reference Truth {#debate-methods}
...
### Run an Idea Through All Five {#run-five}
...
### Recognize Inverted Premises {#recognize-inversion}

Sometimes the quarrel is not opinion within shared premises but different premises. Signals stack:

- Reality as “narrative” or pure construction  
- Limits as temporary obstacles to re-education; blank slate awaiting only the right inscription; natural goodness awaiting only the right social form  
- Survival as morally suspect  
- Tiered loyalty as bigotry  
- Procedure dismissed for equal outcomes  
...
### Precondition for Debate {#precondition-debate}
...
### Refuse the Compassion Weapon {#refuse-compassion-weapon}
...
### Discovered vs Constructed in Live Argument {#live-discovered}
...
### Use the Mirror as a Bundle {#use-mirror}
...
### The Hermetic Argument {#hermetic-argument}
...
### Scope Your Arguments {#scope-arguments}
...
### Test Your Own Side {#test-yourself}

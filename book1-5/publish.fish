...
# Publication-grade build for book1-5 (Cicero / harness edition of
# The Conservative Frame).
#
# Produces three deliverables under ../release/ (names chosen not to
# collide with book1-4's cf_book.*):
#   cfc-book.pdf  - print PDF, LaTeX book class, fonts embedded by xelatex
#                   + optional ghostscript pass for print platforms
#   cfc-book.epub - reflowable EPUB3 for KDP / Apple Books / Kobo
#   cfc-book.html - standalone web edition
#
...
# ---- book design knobs (match book1-4 publish.fish) ----
set TRIM_W   "6in"
set TRIM_H   "9in"
set INNER    "0.875in"
set OUTER    "0.625in"
